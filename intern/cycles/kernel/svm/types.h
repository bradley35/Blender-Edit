...
typedef enum ClosureType {
  ...
  CLOSURE_BSDF_BRADLEY_BLINN_ID,
  CLOSURE_BSDF_BRADLEY_PHONG_ID,
...
#define CLOSURE_IS_BRADLEY(type) (type >= CLOSURE_BSDF_BRADLEY_BLINN_ID && type <= CLOSURE_BSDF_BRADLEY_PHONG_ID)
